...
export default function CaioPage() {
  return (
    <section className="pt-40 pb-20 px-4 md:px-10 xl:px-0 max-w-c-1016 mx-auto">
      <motion.h1
      ...
      <motion.p
        ...
        className="text-xl text-gray-700 dark:text-manatee max-w-3xl mb-10"
      >
      ...
      <div className="relative mb-8 rounded-xl overflow-hidden shadow-solid-6">
        <VideoPlayer src="/videos/caio.mp4" />
      </div>

      <Link
        href="/#contact"
        className="inline-block mb-14 text-white bg-primary hover:bg-primaryho rounded-full px-6 py-3 text-base font-medium transition duration-300"
      >
        Veja uma demo do CAIO em ação
      </Link>
      ...
      >
        <div>
          <h2 className="text-2xl font-semibold text-black dark:text-white mb-2">Minhas especialidades</h2>
        ...
        <div>
          <h2 className="text-2xl font-semibold text-black dark:text-white mb-2">Tecnologias e frameworks</h2>
          <ul className="list-disc pl-5 text-gray-800 dark:text-manatee">
